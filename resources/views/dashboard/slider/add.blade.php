...
@section('content')
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">New Slider</h3>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{old('button_title')}}" class="form-control" name="button_title" placeholder="Text..">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{old('button_link')}}" name="button_link" placeholder="Text..">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" placeholder="Text..">{{old('description')}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
